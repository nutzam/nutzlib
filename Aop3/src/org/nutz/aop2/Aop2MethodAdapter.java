...
public class Aop2MethodAdapter extends NullMethodAdapter implements Opcodes{
	...
	public Aop2MethodAdapter(MethodVisitor mv,
							int access,
							String methodName,
							String desc,
							int methodIndex,
	...
	protected void enhandMethod_Void() {
		...
		mv.visitLabel(l0);
		mv.visitTypeInsn(NEW, "org/nutz/aop2/InterceptorChain");
		mv.visitInsn(DUP);
		visitX(methodIndex);
		...
		mv.visitInsn(AALOAD);
		loadArgsAsArray();
		mv.visitMethodInsn(INVOKESPECIAL, "org/nutz/aop2/InterceptorChain", "<init>", "(ILjava/lang/Object;Ljava/lang/reflect/Method;Ljava/util/List;[Ljava/lang/Object;)V");
		mv.visitMethodInsn(INVOKEVIRTUAL, "org/nutz/aop2/InterceptorChain", "doChain", "()Lorg/nutz/aop2/InterceptorChain;");
		
		{
			if (Type.getReturnType(desc).equals(Type.VOID_TYPE)) {
				mv.visitInsn(POP);
			} else {
				mv.visitMethodInsn(INVOKEVIRTUAL, "org/nutz/aop2/InterceptorChain", "getReturn", "()Ljava/lang/Object;");
				checkCast();
				returnIt();
			}
		}
