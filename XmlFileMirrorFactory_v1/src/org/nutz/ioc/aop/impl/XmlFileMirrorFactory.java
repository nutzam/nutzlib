...
public class XmlFileMirrorFactory implements MirrorFactory {
	...
	public <T> Mirror<T> getMirror(Class<T> type, String name) {
		...
		for (Mapper mapper : list) {
			if (canInterceptor(type) && mapper.namePattern.matcher(type.getName()).find()){
				for (Method method : methods) {
					if (canInterceptor(method)){
	...
	protected boolean canInterceptor(Method method) {
	...
	protected boolean canInterceptor(Class<?> klass) {
